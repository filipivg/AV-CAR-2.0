...
public class AtualizarCliente extends javax.swing.JFrame {
    ...
    public AtualizarCliente(Cliente cliente) {
        ...
        TxFNome.setText(cliente.getNomeRazaoSocial());
        TxFCPF.setText(cliente.getCPF());
        TxFTelefone.setText(cliente.getTelefone() != null ? cliente.getTelefone() : "");
        TxFEmail.setText(cliente.getEmail() != null ? cliente.getEmail() : "");

        if (cliente.getTipoCliente().equals("Físico")) {
            RBntPF.setSelected(true);
        } else {
            RBntPJ.setSelected(true);
        }
    }
